...
export default function CertificatesPage() {
  ...
  return (
    <div className="p-10 space-y-16 max-w-7xl mx-auto">
      <h1 className="text-4xl font-bold text-center text-red-700 tracking-wide">
      ...
      {categories.map((cat, i) => (
        <div key={i}>
          <h2 className="text-2xl font-semibold text-center mb-8 text-red-700 tracking-wide">
            {cat.title}
          </h2>
            ...
            {cat.items.map((item, index) => (
              ...
              >
                <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="text-center bg-gray-50 py-4 text-red-700 font-medium group-hover:bg-red-50 transition-colors">
                    {item.label}
                  </div>
                </div>
              </div>
